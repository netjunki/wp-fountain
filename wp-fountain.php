...
Plugin URI: http://parliamentpress.com/wp-fountain/
...
add_filter('the_content', 'build_scrippet', 1, 1);
add_filter('comment_text', 'build_scrippet', 1, 1);
...
if(!get_option('scrippet_options')) {
    update_option('scrippet_options', $default_options); // create the defaults
}
...
function add_scrippets_admin_panel() {
    add_options_page('Scrippets', 'Scrippets', 8, __FILE__, 'scrippets_options_panel');
}
